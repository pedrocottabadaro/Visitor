...
class PropriedadeVisitorTest {
    ...
    void deveExibirApartamento() {
        ...
        assertEquals("Apartamento{andar=13, bloco='2'}", visitor.exibirApartamento(apartamento));
    }
    ...
    void deveExibirTerreno() {
        ...
        PropriedadeVisitor visitor = new PropriedadeVisitor();
        assertEquals("Terreno{numero=Maria, nome='Bela Vista', complemento=Doutorado}", visitor.exibirTerreno(terreno));
    }
    ...
    void deveExibirCasa() {
        ...
        PropriedadeVisitor visitor = new PropriedadeVisitor();
        assertEquals("Casa{numero=12, complemento='Muro azul'}", visitor.exibirCasa(casa));
    }
}